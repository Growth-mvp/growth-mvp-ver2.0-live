      ...
      <div className="mx-auto max-w-6xl space-y-12">
        ...
        <header className="px-1 py-8 md:py-12">
          ...
          <div className="mt-6 max-w-5xl space-y-4 text-base leading-8 text-slate-700 md:text-lg">
            <p>
              現場で感じる違和感や不満の背景には、単なる人と人の問題ではなく、方針、優先順位、役割責任、評価、意思決定に対する認識の違いが隠れています。
              GROWTH SHIFTは、それを人と人の対立ではなく、経営、部門、現場、それぞれの立場で生じる<span className="font-semibold text-slate-950">
                「認識のズレ」
              </span>{" "}として捉え、構造的に整理します。<br />
              <br /> 
              そしてAIが、そのズレを、会社が目指す方向性に照らしてどうすり合わせるべきかを整理し、「今、本当に話し合うべきポイント」を明確にします。
              <br />誰かを責めるのではなく、現場の違和感を組織の改善につなげ、会社全体の判断基準と行動を変えていくためのルームです。
            </p>
          </div>
        </header>
