      ...
      <div className="mx-auto max-w-6xl space-y-12">
        ...
        <header className="px-1 py-8 md:py-12">
          ...
          <div className="mt-6 max-w-5xl space-y-4 text-base leading-8 text-slate-700 md:text-lg">
            <p>
              社内の不満や違和感の背景には、人や組織の関係性の問題だけでなく、方針、仕組み、優先順位、役割責任、評価、意思決定などへの不納得感があります。
                        ...
                        <div className="flex flex-col gap-4 md:flex-row md:items-start md:justify-between">
                          <div className="flex-1">
                            ...
                            <div className="mb-3 flex flex-wrap items-center gap-2">
                              ...
                              {result?.issueType && (
                                <span className="inline-block rounded-full bg-slate-50 px-3 py-1 text-xs font-semibold text-slate-500">
                                  {result.issueType}
                                </span>
                              )}
                            </div>
                          ...
                          <div className="flex shrink-0 items-center gap-2 md:mt-1">
                            <button
                              ...
                              className="rounded-lg border border-slate-300 px-4 py-2 text-sm font-semibold text-slate-800 transition-colors hover:bg-slate-100"
                            >
                            ...
                            <button
                              ...
                              className="rounded-lg border border-red-200 px-3 py-2 text-sm font-semibold text-red-600 transition-colors hover:bg-red-50 disabled:cursor-not-allowed disabled:bg-red-50 disabled:text-red-300"
                            >
