...
export default function Home() {
  ...
  return (
    <main className="min-h-screen bg-neutral-50 text-neutral-900 dark:bg-neutral-950 dark:text-white">
        ...
        <div className="container mx-auto px-6 pt-10 pb-4 sm:pt-12 sm:pb-5 lg:pt-14 lg:pb-6">
          <div className="mx-auto max-w-3xl text-center">
            ...
            <motion.div
              ...
              className="mt-2 text-[15px] font-semibold tracking-[0.06em] text-neutral-800 sm:text-[17px] lg:text-[20px] dark:text-neutral-100"
            >
              GROWTH SHIFT｜AI企業変革プラットフォーム
            </motion.div>
            ...
            >
              全社戦略・事業戦略・実行計画までを全体最適でつなぎ、日々の業務を会社の成長に直結させる仕組み。
            </motion.p>
            ...
            <motion.div
              ...
              className="mt-6 flex items-center justify-center gap-3 sm:flex-row"
            >
              <Link
                href="/stage1"
                className="inline-flex items-center justify-center rounded-full bg-neutral-950 px-6 py-2.5 text-[14px] font-semibold text-white shadow-[0_14px_36px_rgba(0,0,0,0.14)] transition hover:-translate-y-0.5 hover:opacity-95 dark:bg-white dark:text-neutral-950"
              >
                さっそく始める
              </Link>
              <Link
      ...
      {/* ===== Overview Panels ===== */}
      <section className="container mx-auto px-6 pt-0 pb-8 sm:pt-0 lg:pt-0 lg:pb-10">
      ...
      {/* ===== Steps：モバイル補助導線 ===== */}
      <section className="container mx-auto px-6 pb-24 md:hidden pt-12">
