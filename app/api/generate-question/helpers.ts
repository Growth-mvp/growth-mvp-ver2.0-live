...
export const TEMPLATE12: Record<number, { question: string; reason: string }[]> = {
  ...
  1: [
    {
      question: '次の時代、私たちの事業を取り巻く環境はどのように変化しているでしょうか？',
      reason: '前提を未来に合わせ直すことで、延長線の思考から抜け出せます。技術・規制・顧客行動の変化を具体に挙げ、判断の土台を共有します。'
    },
    {
      question: 'その変化の中で、顧客が本当に求める「価値」は何であり、なぜそれが重要になるのでしょうか？',
      reason: '提供価値を再定義すると、意思決定の軸が一本化します。選ぶ・捨てるの基準が明確になり、活動がばらけることを防げます。'
    },
    {
